...
<div class="content">
    ...
    <div class="pagination-by-month">
        <!-- 前月ボタン -->
        <a class="pagination-link" href="{{ route('attendance.list', ['year' => $prevMonth->year, 'month' => $prevMonth->month]) }}">
        ...
        <!-- 翌月ボタン -->
        <a class="pagination-link" href="{{ route('attendance.list', ['year' => $nextMonth->year, 'month' => $nextMonth->month]) }}">
            翌月
